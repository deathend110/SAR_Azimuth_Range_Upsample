...
\begin{tabular}{@{}cc@{}}
\includegraphics[width=0.48\linewidth]{../assert/Exp4A_NCT_PSNR_AsCurve.png} &
\includegraphics[width=0.48\linewidth]{../assert/Exp4A_NCT_SSIM_AsCurve.png} \\
(a) NCT, PSNR & (b) NCT, SSIM \\
\includegraphics[width=0.48\linewidth]{../assert/Exp4A_RT_PSNR_AsCurve.png} &
\includegraphics[width=0.48\linewidth]{../assert/Exp4A_RT_SSIM_AsCurve.png} \\
(c) RT, PSNR & (d) RT, SSIM
\end{tabular}
