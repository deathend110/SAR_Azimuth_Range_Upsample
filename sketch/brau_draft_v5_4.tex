...
The PSNR-selected bidirectional allocations required 550.6--1141.8 ms per sample and incurred 5.6--15.0\% (10.8\% on average) additional full-pipeline runtime relative to the fastest unidirectional allocation under the same budget.
