...
\begin{equation}
    \operatorname{sign}(s)=\operatorname{sign}(I)+j\operatorname{sign}(Q).
\end{equation}
...
\begin{table}[t]
\caption{Spectral leakage metrics after SAR processing for $Q_{\mathrm{up}}=4$. Lower values indicate cleaner spectral concentration.}
\begin{center}
\scriptsize
\begin{tabular}{c c c c c}
\hline
...
{\footnotesize Fig.~\thefigure. Range-compressed spectra for $Q_{\mathrm{up}}=4$ under different allocation strategies. R4A1 and R1A4 expand the spectrum along one dimension, whereas R2A2 distributes the expansion over both range and azimuth and yields cleaner two-dimensional spectral concentration.}
\end{center}
